$(document).ready(function(){
	...
	//Taking request expor link
	$('.request_export_prepear').click(function(){
		$.ajax({
			type:'post',
			data: 'req_export=true',
	...
	//Taking cars info expor link
	$('.cars_export_prepear').click(function(){
		$.ajax({
			type:'post',
			data: 'prod_export=true',
			success: function(data){
				$('.cars_export_link')
					.attr('href', data)
					.removeClass('disabled')
	...
	//Taking cars images expor link
	$('.cars_img_export_prepear').click(function(){
		$.ajax({
			type:'post',
			data: 'img_export=true',
			success: function(data){
				$('.cars_img_export_link')
					.attr('href', data)
					.removeClass('disabled')
					.addClass('btn-success');
			}
	...
	// 	$('.refresh_cars').removeClass('disabled');
	// })

	// $('.update_cars_form').submit(function(e){
	// 	e.preventDefault();
