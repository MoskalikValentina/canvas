...
#####Ссылки:
* [https://www.npmjs.com/package/jasmine-core](https://www.npmjs.com/package/jasmine-core)

Корневы файлы для работы фреймоврка Jasmine


###jasmine
#####Используемая версия - ^2.4.1

#####Ссылки:
* [http://jasmine.github.io/](http://jasmine.github.io/)
* [https://www.npmjs.com/package/jasmine-core](https://www.npmjs.com/package/jasmine-core)

Jasmine- фреймворк для  тестирования js 

###karma
#####Используемая версия - 1.x
...
###karma-jasmine
#####Используемая версия - 1.x || ^0.3.6

#####Ссылки:
* [https://www.npmjs.com/package/karma-jasmine](https://www.npmjs.com/package/karma-jasmine)
* [https://github.com/karma-runner/karma-jasmine](https://github.com/karma-runner/karma-jasmine)

Адаптер для Jasmine фреймворка

###karma-jquery
#####Используемая версия - 0.1.0

#####Ссылки:
* [https://www.npmjs.com/package/karma-jquery](https://www.npmjs.com/package/karma-jquery)

Адаптер jQuery для karma

###babel-preset-es2015
#####Используемая версия - ^6.9.0
...
Настройки для всех плагинов работающих на es2015(es6)


###babel-polyfill
#####Используемая версия - ^6.16.0

#####Ссылки:
* [https://www.npmjs.com/package/babel-polyfill](https://www.npmjs.com/package/babel-polyfill)

Обеспечивает полифиллы, необходимых для полноценной работы в среде ES2015+ 